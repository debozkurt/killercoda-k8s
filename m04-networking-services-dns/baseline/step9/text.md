...
`kubectl port-forward` (step 7) sits below all three — it reaches the Pod through the apiserver, so it proves the process is listening without proving anything about the Service.
